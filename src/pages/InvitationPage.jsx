...
const InvitationPage = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // *** MODIFICACIÓN ***
    // Limpia el error del campo específico en cuanto el usuario empieza a escribir
    if (fieldErrors[name]) {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={formRef} className="mt-16 card-elegant slide-up">
            <div className="relative overflow-hidden">
              {/* Formulario */}
              {!formSubmitted ? (
                // *** MODIFICACIÓN ***: Añadido 'noValidate' para desactivar validación del navegador
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input
                        ...
                        id="nombre"
                        name="nombre"
                        // *** MODIFICACIÓN ***: Quitamos 'required'
                        // *** MODIFICACIÓN ***: Clases condicionales para el borde rojo
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-200 ${
                          fieldErrors.nombre
                            ? 'border-red-500 focus:ring-red-500' // Estado de error
                            : 'border-gray-300 focus:ring-primary-500' // Estado normal
                        }`}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                      />
                      {/* *** CORRECCIÓN DE BUG ***: Cambiado de fieldErrors.nombre a fieldErrors.email */}
                      {fieldErrors.email && (
